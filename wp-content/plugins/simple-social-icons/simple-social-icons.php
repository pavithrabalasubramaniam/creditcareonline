...
class Simple_Social_Icons_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$this->profiles = apply_filters( 'simple_social_default_profiles', array(
			...
			'yelp' => array(
				'label'   => __( 'yelp URI', 'simple-social-icons' ),
				'pattern' => '<li class="ssi-yelp"><a href="%s" %s><svg role="img" class="social-yelp" aria-labelledby="social-yelp"><title id="social-yelp">' . __( 'Yelp', 'simple-social-icons' ) . '</title><use xlink:href="' . esc_url( plugin_dir_url(__FILE__) . 'symbol-defs.svg#social-yelp' ) . '"></use></svg></a></li>',
			),
			'youtube' => array(
